...
exports.deleteProduct = exports.postProduct = exports.fetchProducts = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _Products = __webpack_require__(50);

var _Products2 = _interopRequireDefault(_Products);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

const fetchProducts = ({ page, size }) => _Products2.default.query().select().page(parseInt(page), parseInt(size)).then(products => products);

const postProduct = product => _Products2.default.query().insert(_extends({}, product, { color: JSON.stringify(product.color) })).then(product => product instanceof _Products2.default ? product : false);

const deleteProduct = id => _Products2.default.query().delete().where({ id }).then(affectedRows => affectedRows === 1);
...
var arrayReduce = __webpack_require__(152),
    deburr = __webpack_require__(153),
...
exports.default = new _koa2.default().use((0, _cors2.default)()).use((0, _koaBody2.default)()).use(_products2.default.routes()).listen(PORT, () => console.log(`Backend service listen on port: ${PORT}`));
...
var _products = __webpack_require__(48);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = new _koaRouter2.default().get('/products', _products.List).post('/products', _products.Create).delete('/products/:id', _products.Delete);
...
const List = async ctx => {
  try {
    ...
    const products = await (0, _products.fetchProducts)({ page, size });
    if (!products) {
      ctx.status = 409;
      ctx.body = {
...
let Products = class Products extends _Model2.default {};
...
var _objection = __webpack_require__(52);
...
var _connection = __webpack_require__(57);

var _connection2 = _interopRequireDefault(_connection);

var _mapKeys = __webpack_require__(61);

var _mapKeys2 = _interopRequireDefault(_mapKeys);

var _camelCase = __webpack_require__(143);

var _camelCase2 = _interopRequireDefault(_camelCase);

var _snakeCase = __webpack_require__(160);

var _snakeCase2 = _interopRequireDefault(_snakeCase);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_objection2.default.Model.knex(_connection2.default);

let Model = class Model extends _objection2.default.Model {
  $formatDatabaseJson(json) {
    return (0, _mapKeys2.default)(json, (v, k) => (0, _snakeCase2.default)(k));
  }

  $parseDatabaseJson(json) {
    return (0, _mapKeys2.default)(json, (v, k) => (0, _camelCase2.default)(k));
  }
...
var rb = __webpack_require__(55).randomBytes;
...
const config = __webpack_require__(58)[environment];
exports.default = __webpack_require__(60)(config);
...
module.exports = {
  development: {
    client: 'postgres',
    connection: 'postgres://postgres:777@localhost:5432/colors',
    migrations: {
...
var toString = __webpack_require__(5),
    upperFirst = __webpack_require__(145);
...
var createCaseFirst = __webpack_require__(146);
...
var castSlice = __webpack_require__(147),
...
var deburrLetter = __webpack_require__(154),
    toString = __webpack_require__(5);
...
var basePropertyOf = __webpack_require__(155);
...
var _productValidator = __webpack_require__(162);
...
const Create = async ctx => {
  try {
    const { isValid, errors } = (0, _productValidator2.default)(ctx.request.body);
    ...
    const product = await (0, _products.postProduct)(ctx.request.body);
    if (!product) {
      ctx.status = 409;
      ctx.body = {
...
exports.default = ({ name, color }) => {
  ...
  if (!_validator2.default.isLength(name, { min: 4, max: 8 })) {
    errors.name = {
      title: 'Name error',
  ...
  if (!_validator2.default.isAlphanumeric(name)) {
    errors.name = {
      title: 'Name error',
...
const Delete = async ctx => {
  try {
    ...
    if (!(await (0, _products.deleteProduct)(id))) {
      ctx.status = 409;
      ctx.body = {
